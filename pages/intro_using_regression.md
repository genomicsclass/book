...
Imagine you are Galileo back in the 16th century trying to describe the velocity of an objects falling. An assistant climbs the Tower of Pizza and drops a ball while several another record the position at different times. They had the data to Galileo and this is what he sees:
...
![plot of chunk unnamed-chunk-1](figure/intro_using_regression-unnamed-chunk-1-1.png) 

He has a theory that acceleration is constant and that therefore that the position should follow a parabola. So he models the data with 
...
But what are the $\beta$s?A standard approach in science is to find the values that minimize the distance of the fitted curve to the data:
...
![plot of chunk unnamed-chunk-3](figure/intro_using_regression-unnamed-chunk-3-1.png) 
...
![plot of chunk unnamed-chunk-19](figure/intro_using_regression-unnamed-chunk-19-1.png) 
...
![plot of chunk unnamed-chunk-20](figure/intro_using_regression-unnamed-chunk-20-1.png) 
